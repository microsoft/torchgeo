...
# + [markdown] id="p63J-QmUrMN-"
# Copyright (c) Microsoft Corporation. All rights reserved.
#
# Licensed under the MIT License.

# + [markdown] id="XRSkMFqyrMOE"
# # Pretrained Weights
#
...
# + [markdown] id="NBa5RPAirMOF"
# ## Setup
#
# First, we install TorchGeo.

# + colab={"base_uri": "https://localhost:8080/"} id="5AIQ1B9DrMOG" outputId="6bf360ea-8f60-45cf-c96e-0eac54818079"
# %pip install torchgeo

# + [markdown] id="IcCOnzVLrMOI"
# ## Imports
#
...
# + [markdown] id="njAH71F3rMOJ"
# The following variables can be used to control training.

# + id="TVG_Z9MKrMOJ" nbmake={"mock": {"batch_size": 1, "fast_dev_run": true, "max_epochs": 1, "num_workers": 0}}
batch_size = 10
num_workers = 2
max_epochs = 10
fast_dev_run = False

# + [markdown] id="QNnDoIf2rMOK"
# ## Datamodule
#
...
# + colab={"base_uri": "https://localhost:8080/", "height": 86, "referenced_widgets": ["8fb7022c6e4947d8955ed6da0d89ef05", "c5adf2ec163a43f08b3de98d0eabf8df", "4c6928b34aef4e778c837993c4197bcd", "ec96c2767d30412c8af5306a5c2f5ee3", "cbfb522eafbd4d4991ca5f45ad32bd2c", "5d02318e1c9e4034bd686527cdbb18ef", "739421651fb84d31a7baeacef2f8226c", "8d83a7dad192492facd4b3e03cbb2392", "fc423924e14a49b18b99064ab45e3f1e", "17dd6c0bbbf947b1a47a9cb8267d43ef", "8704c42feea442abb67cfd55ae3c4fa9"]} id="RZ8MPYH1rMON" outputId="fa683b8f-da21-4f26-ca3a-46163c9f12bf"
...
# + colab={"base_uri": "https://localhost:8080/"} id="veVvF-5LrMOP" outputId="698e3e9e-8a53-4897-d40e-13b43470e29e"
trainer = Trainer(
