...
class TestSemanticSegmentation:
    ...
    def test_weight_file(self, checkpoint: str) -> None:
        SemanticSegmentation(backbone='resnet18', weights=checkpoint, num_classes=6)
    ...
    def test_class_weights(self) -> None:
        ...
        task = SemanticSegmentation(class_weights=class_weights_list, num_classes=3)
        ...
        task = SemanticSegmentation(class_weights=class_weights_tensor, num_classes=3)
