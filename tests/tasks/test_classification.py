...
class TestClassification:
    ...
    def test_class_weights(self) -> None:
        ...
        task = Classification(class_weights=class_weights_list, num_classes=3)
        ...
        task = Classification(class_weights=class_weights_tensor, num_classes=3)
    ...
    def test_freeze_backbone(self, model_name: str) -> None:
        model = Classification(model=model_name, num_classes=10, freeze_backbone=True)
