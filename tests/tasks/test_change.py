...
from torchgeo.tasks import ChangeDetection
...
class TestChangeDetection:
    ...
    def test_predict(self, fast_dev_run: bool) -> None:
        ...
        model = ChangeDetection(backbone='resnet18', in_channels=13, model='unet')
        trainer = Trainer(
            accelerator='cpu',
    ...
    def test_weight_file(self, checkpoint: str) -> None:
        ChangeDetection(backbone='resnet18', weights=checkpoint)
    ...
    def test_class_weights(self) -> None:
        ...
        task = ChangeDetection(task='multiclass', num_classes=3)
