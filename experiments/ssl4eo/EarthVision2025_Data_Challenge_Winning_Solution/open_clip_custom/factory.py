...
from .transform import image_transform_v2, AugmentationCfg, PreprocessCfg, merge_preprocess_dict, merge_preprocess_kwargs, image_transform_tensor
...
def create_model_and_transforms(
    ...
    preprocess_train = image_transform_tensor(
        pp_cfg,
        is_train=True,
        aug_cfg=aug_cfg,
    )
