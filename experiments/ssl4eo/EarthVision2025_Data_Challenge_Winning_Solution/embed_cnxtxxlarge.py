...
parser.add_argument("--output-path", "-o", type=str, default="embeddings_clip_convnext_xxlarge_256_ftregress_e22.csv", help="Path to the output CSV file")
...
# Path to the ckpt
ckpt = args.ckpt_path # '/mnt/disk3/SSL4EO_TEST/cnext_xxlarge_256_ftregress/epoch_22.pt'
...
model, _, preprocess = open_clip.create_model_and_transforms('convnext_xxlarge', pretrained=ckpt)
