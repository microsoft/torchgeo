...
DATA_DIR = "/projects/dali/data/l8biome"  # path to the L8Biome data directory
...
if __name__ == "__main__":
    ...
    for model, backbone, lr, loss, weight_init in itertools.product(
        ...
        output_dir = os.path.join("output", "l8biome_experiments")
        log_dir = os.path.join(output_dir, "logs")
        config_file = os.path.join("conf", "l8biome.yaml")
