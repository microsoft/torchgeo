...
This document provides the governance policy for the Project. Maintainers agree to this policy and to abide by all Project policies, including the [code of conduct](https://github.com/torchgeo/governance/blob/main/CODE-OF-CONDUCT.md), [trademark policy](https://github.com/torchgeo/governance/blob/main/TRADEMARKS.md), [antitrust policy](https://github.com/torchgeo/governance/blob/main/ANTITRUST.md), and [AI policy](https://github.com/torchgeo/governance/blob/main/AI-POLICY.md) by adding their name to the [maintainers.md file](./MAINTAINERS.md).
