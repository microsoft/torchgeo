...
def _download_pinned(weights: WeightsEnum) -> str:
    ...
    Returns:
        Directory holding the downloaded config and weights.
    """
...
def _olmoearth(
    ...
    Args:
        ...
        model_size: Model size to build when randomly initialized.
        model_version: Architecture version to build when randomly initialized.
