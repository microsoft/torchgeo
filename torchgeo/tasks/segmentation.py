...
class SemanticSegmentation(ClassificationMixin, BaseTask):
    ...
    def __init__(
        ...
        """Initialize a new SemanticSegmentation instance.
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if x.ndim == 5:
            warnings.warn(
                ...
                'SemanticSegmentation is deprecated and will be removed in a '
                'future release. Use SpatioTemporalSegmentation instead.',
                DeprecationWarning,
                stacklevel=1,
            )
