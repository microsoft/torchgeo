    ...
    * https://www.openstreetmap.org/copyright
    ...
    def __init__(
        ...
        if isinstance(paths, str | pathlib.Path):
            ...
            self.root = pathlib.Path(next(iter(paths)))
        ...
        for endpoint in self._overpass_endpoints:
            try:
                ...
                if len(gdf) > 0:
                    ...
                    gpd.GeoDataFrame(columns=['geometry'], geometry='geometry', crs='EPSG:4326').to_file(data_file, driver='GeoJSON')
    ...
    def __getitem__(self, query: Any) -> dict[str, Any]:
        ...
        if len(gdf) > 0:
            ...
            sample['vector'] = gpd.GeoDataFrame(columns=['geometry'], geometry='geometry', crs='EPSG:4326')
    ...
    def plot(
        ...
        if len(gdf) == 0:
            ax.text(0.5, 0.5, 'No data found for this area', 
