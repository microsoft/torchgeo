...
class SpaceNet4(SpaceNet):
    ...
    * https://arxiv.org/abs/1903.12239
    ...
    tarballs: ClassVar[dict[str, dict[int, list[str]]]] = {
        'train': {
            6: [
                'train/Atlanta_nadir7_catid_1030010003D22F00.tar.gz',
                'train/Atlanta_nadir8_catid_10300100023BC100.tar.gz',
                'train/Atlanta_nadir10_catid_1030010003993E00.tar.gz',
                'train/Atlanta_nadir10_catid_1030010003CAF100.tar.gz',
                'train/Atlanta_nadir13_catid_1030010002B7D800.tar.gz',
                'train/Atlanta_nadir14_catid_10300100039AB000.tar.gz',
                'train/Atlanta_nadir16_catid_1030010002649200.tar.gz',
                'train/Atlanta_nadir19_catid_1030010003C92000.tar.gz',
                'train/Atlanta_nadir21_catid_1030010003127500.tar.gz',
                'train/Atlanta_nadir23_catid_103001000352C200.tar.gz',
                'train/Atlanta_nadir25_catid_103001000307D800.tar.gz',
                'train/Atlanta_nadir27_catid_1030010003472200.tar.gz',
                'train/Atlanta_nadir29_catid_1030010003315300.tar.gz',
                'train/Atlanta_nadir30_catid_10300100036D5200.tar.gz',
                'train/Atlanta_nadir32_catid_103001000392F600.tar.gz',
                'train/Atlanta_nadir34_catid_1030010003697400.tar.gz',
                'train/Atlanta_nadir36_catid_1030010003895500.tar.gz',
                'train/Atlanta_nadir39_catid_1030010003832800.tar.gz',
                'train/Atlanta_nadir42_catid_10300100035D1B00.tar.gz',
                'train/Atlanta_nadir44_catid_1030010003CCD700.tar.gz',
                'train/Atlanta_nadir46_catid_1030010003713C00.tar.gz',
                'train/Atlanta_nadir47_catid_10300100033C5200.tar.gz',
                'train/Atlanta_nadir49_catid_1030010003492700.tar.gz',
                'train/Atlanta_nadir50_catid_10300100039E6200.tar.gz',
                'train/Atlanta_nadir52_catid_1030010003BDDC00.tar.gz',
                'train/Atlanta_nadir53_catid_1030010003193D00.tar.gz',
                'train/Atlanta_nadir53_catid_1030010003CD4300.tar.gz',
                'train/geojson.tar.gz',
            ]
        },
