...
class BioMassters(NonGeoDataset):
    ...
    * TBD
    ...
    def __init__(
        ...
        assert set(sensors).issubset(set(self.valid_sensors)), f"Please choose a subset of valid sensors {self.valid_sensors}."
        ...
        month_mapping = {month: datetime.strptime(month, "%B").month for month in self.df['month'].unique()}
