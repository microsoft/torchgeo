...
class CropHarvest(NonGeoDataset):
    ...
    * https://openreview.net/forum?id=JtjzUXPEaCu
    ...
    classes = ['None', 'Other', 'cerrado', 'pasture', 'coffee', 'uncultivated soil', 'hay',
       'conversion area', 'eucalyptus', 'brachiaria', 'cotton', 'wheat',
       'rice', 'orchard', 'alfalfa', 'maize', 'vineyard', 'cassava',
       'sorghum', 'bean', 'groundnut', 'fallowland', 'millet', 'tomato',
       'sugarcane', 'sweetpotato', 'banana', 'soybean', 'cabbage',
       'safflower', 'dry bean', 'bush bean', 'yellow maize',
       'white sorghum', 'sunflower', 'palm', 'potatoes',
       'groundnuts or peanuts', 'barley', 'pulses',
       'blé tendre d\x92hiver', 'maïs',
       ...
       'orge de printemps', 'jachère de 6 ans ou plus', "orge d'hiver",
       'colza d\x92hiver', 'pomme de terre de consommation',
       'jachère de 5 ans ou moins', 'autre trèfle',
       'autre graminée fourragère pure de 5 ans ou moins',
       'autre fourrage annuel d\x92un autre genre',
       'betterave non fourragère / bette', 'autre luzerne', 'lin fibres',
       'mélange de légumineuses prépondérantes au semis et de graminées fourragères de 5 ans ou moins',
       '\x8cillette', 'pois de printemps semé avant le 31/05',
       'triticale d\x92hiver', 'soja', 'avoine d\x92hiver', 'verger',
       'autre prairie temporaire de 5 ans ou moins', 'oignon / échalote',
       'haricot / flageolet', 'pois d\x92hiver',
       'laitue / batavia / feuille de chêne', 'chanvre', 'bois pâturé',
       'avoine de printemps',
       'prairie en rotation longue (6 ans ou plus)',
       'féverole semée avant le 31/05', 'blé tendre de printemps',
       'sorgho', 'tournesol', 'sarrasin',
       'mélange de légumineuses fourragères prépondérantes et de céréales et/ou d\x92oléagineux',
       'maïs ensilage', 'coriandre', 'mélange de céréales',
       'blé dur d\x92hiver', 'autre légume ou fruit annuel', 'épeautre',
       'mélange de protéagineux (pois et/ou lupin et/ou féverole) prépondérants semés avant le 31/05 et de céréales',
       'carotte', 'autre légume ou fruit pérenne', 'petit fruit rouge',
       'pois chiche', 'ray-grass de 5 ans ou moins', 'petits pois',
       'surface pastorale - herbe prédominante et ressources fourragères ligneuses présentes',
       'seigle d\x92hiver', 'autre pois fourrager de printemps',
       'autre vesce', 'luzerne déshydratée',
       'lentille cultivée (non fourragère)',
       'autre pois fourrager d\x92hiver', 'betterave fourragère',
       'autre sainfoin', 'moha', 'fraise',
       'autre céréale d\x92un autre genre', 'lin non textile d\x92hiver',
       'épinard', 'persil', 'dactyle de 5 ans ou moins',
       'autre plante à parfum, aromatique et médicinale annuelle',
       'trèfle déshydraté', 'menthe', 'fétuque de 5 ans ou moins',
       'potiron / potimarron',
       ...
       'mélange de légumineuses fourragères (entre elles)', 'moutarde',
       'courge musquée / butternut', 'cerfeuil', 'seigle de printemps',
       'triticale de printemps', 'colza de printemps',
       'culture sous serre hors sol', 'radis', 'navette d\x92été',
       'lentille fourragère', 'estragon', 'oseille', 'camomille',
       'cresson', 'aubergine', 'tomate', 'thym', 'blé dur de printemps',
       ...
       'maïs doux', 'lotier', 'fenouil',
       'autre céréale d\x92hiver de genre triticum', 'noix',
       'vigne : raisins de cuve', 'vesce déshydratée', 'noisette',
       'courgette / citrouille', 'autre oléagineux d\x92un autre genre',
       'céleri', 'chou', 'navet', 'panais', 'chicorée / endive / scarole',
       'poivron / piment', 'aïl', 'chanvre sans étiquette conforme',
       'poireau', 'marjolaine / origan',
       'mélange de protéagineux (pois et/ou lupin et/ou féverole)',
       'topinambour', 'fève', 'cameline', 'autre féverole fourragère',
       'aneth', 'gesse', 'fenugrec', 'mélange d\x92oléagineux',
       'concombre / cornichon', 'houblon',
       'autre céréale de genre panicum',
       'lupin doux de printemps semé avant le 31/05', 'sarriette',
       'sauge', 'artichaut ', 'lavande / lavandin', 'melon',
       'autre mélilot', 'mâche', 'plantain psyllium',
       'cerise bigarreau pour transformation',
       'surface pastorale - ressources fourragères ligneuses prédominantes',
       'pastèque', 'autre céréale de printemps de genre zea',
       'canne à sucre - propriété ou faire valoir direct',
       'canne à sucre - fermage', 'agrume', 'verger (dom)',
       'légume sous abri', 'banane créole (fruit et légume) - autre',
       'ananas', 'plante aromatique (autre que vanille)',
       'vanille sous bois', 'café / cacao', 'curcuma', 'géranium',
       'vanille', 'banane créole (fruit et légume) - fermage',
       'plante médicinale', 'horticulture ornementale de plein champ',
       'horticulture ornementale sous abri',
       'banane créole (fruit et légume) - propriété ou faire valoir direct',
       'autre céréale de genre fagopyrum', 'ylang-ylang',
       'canne à sucre - autre', 'canne à sucre - indivision',
       'banane créole (fruit et légume) - indivision', 'avocat',
       'plante à parfum (autre que géranium et vétiver)',
       'banane créole (fruit et légume) - réforme foncière', 'arachide ',
       'vigne : raisins de table', 'vanille verte',
       'canne à sucre - réforme foncière', 'jachère noire',
       'banane export - fermage',
       'banane export - propriété ou faire valoir direct',
       'banane export - autre', 'banane export - indivision',
       'prune d\x92ente pour transformation', 'wetland',
       'abandoned (overgrown)', 'urban', 'shrubland', 'mixed forage',
       'pasture (undiff)', 'sod', 'cereals (undiff)', 'barley (undiff)',
       'corn', 'timothy', 'spring wheat', 'soybeans', 'forest', 'nursery',
       'winter barley', 'canola/rapeseed', 'winter wheat',
       'unimproved pasture', 'christmas trees', 'greenhouse',
       'winter rye', 'pasture/forage', 'red clover', 'abandoned (shrubs)',
       'other', 'fallow', 'native grassland', 'barren', 'water', 'oats',
       'coniferous', 'white clover', 'broadleaf', 'clover (undiff)',
       'sunflowers', 'greenfeed (mixed)', 'beans (undiff)', 'apples',
       'vegetables (undiff)', 'raspberry', 'fruits (berry & annual)',
       'strawberry', 'onions', 'broccoli', 'cauliflower', 'peas (undiff)',
       'field peas', 'sugarbeets', 'ginseng', 'rye (undiff)', 'cherries',
       'cucumber', 'tomatoes', 'zucchini', 'carrot', 'tobacco',
       'asparagus', 'other agriculture (undiff)', 'lettuce',
       'pumpkin/squash', 'brussel sprout', 'lavendar', 'sweet corn',
       'peaches', 'pepper', 'pears', 'miscanthus', 'fruits (trees)',
       'blueberry - high bush', 'fababeans', 'mixedwood', 'hops',
       'buckwheat', 'spring rye', 'too wet to seed', 'blueberry (undiff)',
       'triticale (undiff)', 'ryegrass', 'flaxseed', 'birdsfoot trefoil',
       'ornemental', 'plums', 'apricots', 'spring barley', 'sweet clover',
       'wheat (undiff)', 'fescue', 'beetroot', 'spring triticale',
       'wheatgrass', 'eggplant', 'blueberry - low bush', 'cranberry',
       'mustard', 'hemp', 'blackberry', 'dill', 'herbs', 'cedar',
       'hazelnut', 'raddish', 'nuts', 'deforested', 'winter cereals',
       'other nursery', 'oilseeds (undiff)', 'pulses (undiff)',
       'winter triticale', 'poplar', 'celery', 'hascap', 'walnut',
       'other berries', 'peatland - harvested', 'other nut', 'spelt',
       'biofuel (undiff)', 'artichoke', 'other forage', 'vetch',
       'lentils', 'quinoa', 'other orchards', 'forage crops', 'meadows',
       'rye', 'oil seeds', 'root crops', 'groundnuts', 'sesame']
