...
from ..datasets import RESISC45, RESISC45Clustered
...
class RESISC45DataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        self.train_aug = AugmentationSequential(
            ...
            #K.ColorJitter(p=0.1, brightness=0.1, contrast=0.1, saturation=0.1, hue=0.1),
            data_keys=["image"],
        )


class RESISC45ClusteredDataModule(NonGeoDataModule):
    """LightningDataModule implementation for the RESISC45 dataset.
    ...
    def __init__(
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.datasets.RESISC45`.
        """
        super().__init__(RESISC45Clustered, batch_size, num_workers, **kwargs)
