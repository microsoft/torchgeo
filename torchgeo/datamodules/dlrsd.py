...
from ..datasets import DLRSD, DLRSDMultilabel
...
class DLRSDDataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        super().__init__(DLRSD, batch_size, num_workers, **kwargs)
...
class DLRSDMultilabelDataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize a new DLRSDMultilabelDataModule instance.
        ...
        Args:
            ...
            seed: Random seed for reproducible train/val/test splits.
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.datasets.DLRSDMultilabel`.
        """
        super().__init__(DLRSDMultilabel, batch_size, num_workers, **kwargs)
    ...
    def setup(self, stage: str) -> None:
        ...
        Args:
            stage: Either 'fit', 'validate', 'test', or 'predict'.
        """
        dataset = DLRSDMultilabel(**self.kwargs)
        generator = torch.Generator().manual_seed(self.seed)
