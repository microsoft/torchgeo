...
class EnviroatlasLearnPriorTask(LightningModule):
    ...
    def config_task(self, kwargs: Dict[str, Any]) -> None:
        ...
        # five from the blurred NLCD remapped to EA5, plus roads, buildings, waterways and waterbodies
        self.in_channels = 9 
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.layers = [f"prior_from_cooccurrences_{nlcd_blur_kernelsize}_{nlcd_blur_sigma}_no_osm_no_buildings",
                       "e_buildings", "c_roads", "d2_waterbodies", "d1_waterways", "h_highres_labels"]
